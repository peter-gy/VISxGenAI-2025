...
import * as vgplot from "npm:@uwdata/vgplot@0.18.0";
import AnchorJS from "npm:anchor-js@5.0.0";
import lzString from "npm:lz-string@1.5.0";
import tippy from "npm:tippy.js@6.3.7";
import * as tocbot from "npm:tocbot@4.36.4";
import * as vega from "npm:vega@6.1.2";
import vegaEmbed from "npm:vega-embed@7.0.2";
import arrow from "npm:vega-loader-arrow@0.3.2";
