...
const {
		...
		prototype: { hasOwnProperty: Ct },
	} = Object,
	{ toStringTag: pt } = Symbol,
	Le = {},
	q = mt;
function ge(e, t) {
	return Ct.call(e, t);
...
function be(e) {
	return e[pt] || (e.constructor && e.constructor.name) || "Object";
}
function W(e, t) {
	try {
		const n = e[t];
...
const { getPrototypeOf: ye, getOwnPropertyDescriptors: ft } = Object,
	Pe = ye({});
function Qe(e, t, n, i) {
	let o = Te(e),
		r,
			...
			: o
				...
				: (c = je(e))
					? ((r = `Immutable.${c.name}${c.name === "Record" ? "" : `(${e.size})`}`),
						(o = c.arrayish),
						(a = c.arrayish ? _t : c.setish ? Zt : vt))
					: i
						? ((r = be(e)), (a = Gt))
						: ((r = be(e)), (a = U));
	...
	if (!l.done) {
		...
		(u.className = "observablehq--field"),
			...
			u.addEventListener("mouseup", function (g) {
				...
				for (let b = 0; !(l = a.next()).done && b < 19; ++b)
					s.insertBefore(l.value, s.lastChild.previousSibling);
...
function* Gt(e) {
	...
	for (const n of q(e)) yield R(z(n), W(e, n), "observablehq--symbol");
	const t = ye(e);
	t && t !== Pe && (yield Ue(t));
}
function* U(e) {
...
function Ue(e) {
	...
	return (
		...
		t.appendChild(v(e, void 0, void 0, void 0, !0)),
		t
	);
}
function R(e, t, n) {
...
function* Xt(e) {
	...
	for (const i = e.size; n < i; ++n)
		n > t + 1 && (yield le(n - t - 1)), yield v(e.get(n), !0), (t = n);
...
function* Rt(e) {
	...
	for (const i = e.length; n < i; ++n)
		n in e &&
			(n > t + 1 && (yield le(n - t - 1)), yield v(W(e, n), !0), (t = n));
	n > t + 1 && (yield le(n - t - 1));
	for (const i in e)
		!ze(i) && ge(e, i) && (yield D(i, W(e, i), "observablehq--key"));
	for (const i of q(e)) yield D(z(i), W(e, i), "observablehq--symbol");
}
function* M(e) {
...
`),
			...
			return (
				...
				u.addEventListener("mouseup", function (b) {
					b.stopPropagation(), se(s, v(e, t, !0, i));
				}),
				s
			);
		}
...
function dn(e, t) {
	...
	for (const [i, o] of cn)
		for (const r of e.querySelectorAll(i)) {
			...
			o === "srcset" ? r.setAttribute(o, Cn(a, n)) : r.setAttribute(o, n(a));
		}
}
function un(e) {
...
function fn(e, { autodisplay: t, assets: n }) {
	return {
		...
		rejected(i) {
			console.error(i), (this._error = !0), O(e), pn(e, i);
		},
	};
}
...
function H(e, t, n, i) {
	n || (n = $),
		Object.defineProperties(this, {
			...
			_definition: { value: ve, writable: !0 },
...
Object.defineProperties(ue.prototype, {
	...
	derive: { value: Sn, writable: !0, configurable: !0 },
...
function ii(e) {
	...
	function s(d) {
		if (e._version !== n) throw Y;
		return hn(d) ? ((r || pe(e)).then(ai(d)), oi(e, n, d)) : d;
	}
	a.then(
		(d) => {
...
function nt(e, t = document.baseURI) {
	...
	let i = xe.get(n);
	return i || ((i = new T(n, e.split("/").pop())), xe.set(n, i)), i;
}
async function J(e) {
...
const _i = Object.freeze(
	Object.defineProperty(
		{ __proto__: null, canvas: pi, context2d: bi, svg: fi, text: hi, uid: Zi },
		Symbol.toStringTag,
		{ value: "Module" },
	),
);
...
const wi = () =>
	...
	Yi = () =>
		p(() => import("./duckdb-DfnMPd4u.js"), [], import.meta.url).then(
			(e) => e.DuckDBClient,
		),
	Ni = () =>
		p(
	...
	Ji = () =>
		p(() => import("./md-CbR3Kjir.js"), [], import.meta.url).then((e) => e.md),
	Ti = () =>
...
function x(e, t, n = fn) {
		...
		if (
			(G.define(
				...
				() => {
					const y = g._version;
					return (E) => {
						if (y < I) throw new Error("stale display");
						if (e.variables[0] !== g) throw new Error("stale display");
						return y > I && O(e), (I = y), Oe(e, E), E;
					};
				},
			),
	...
	if ((u.push(g.define(b, r, o)), l != null)) {
		if (s) {
			const I = Je(l, "viewof$");
			u.push(K.define(I, [l], Ae));
		} else if (d) {
			const I = Je(l, "mutable "),
				G = `cell ${i}`;
			g.define(I, [G], ([y]) => y),
				u.push(
					K.define(l, r, o),
					K.define(G, [l], gi),
					K.define(`mutable$${I}`, [G], ([, y]) => y),
				);
		}
	} else for (const I of a) u.push(K.variable(!0).define(I, [b], (G) => G[I]));
}
function Je(e, t) {
	...
	{ root: document.getElementById("cell-8"), expanded: [], variables: [] },
	{
		...
		body: async (e, t, n, i, o, r, a, l) => {
			const c = {
					...
					summary:
						"Aggregated view of average diamond price and carat weight by cut quality.",
					fields: [
						{
							name: "cut",
							label: "Cut",
							description:
								"Derived from cut: Trimmed string value of the diamond's cut quality.",
						...
						},
						{
							...
							label: "Avg Carat",
							description:
								"Derived from carat: Average carat weight of diamonds, excluding NULL values, grouped by cut quality.",
						...
						},
						{
							...
							label: "Avg Price",
							description:
								"Derived from price: Average price of diamonds, excluding NULL values, grouped by cut quality.",
							semantic_type: "Money",
							role: "primary",
						},
					],
				...
				s = {
					...
					encoding: {
						...
						tooltip: [
							{ field: "cut", title: "Cut", type: "nominal" },
							{ field: "avg_carat", title: "Avg Carat", type: "quantitative" },
							{ field: "avg_price", title: "Avg Price", type: "quantitative" },
						],
						x: {
							field: "avg_carat",
						...
						y: { field: "cut", sort: "-x", title: "Cut", type: "ordinal" },
					},
			...
			const u = "dataset_01",
				g =
					"https://visxgenai-cdn.peter.gy/sessions/enthralled-adaptation-rob-sympathetically/artifacts/datasets.parquet";
			await i(o, u, g);
			const b = await r({ table: u, spec: s, metadata: c, coordinator: a });
			l(b.viewClient.node()), l(b.tableClient.node());
	...
	{ root: document.getElementById("cell-12"), expanded: [], variables: [] },
	{
		...
		body: async (e, t, n, i, o, r, a, l) => {
			const c = {
					...
					summary:
						"A summary of the median diamond price, segmented by color and clarity grades, providing insight into how these two key attributes collectively influence market value.",
					fields: [
						{
							name: "color",
							label: "Color",
						...
						},
						{
							...
							label: "Clarity",
							description:
								"Original field [clarity] used without modification.",
							semantic_type: "Category",
							role: "primary",
						},
						{
							...
							label: "Median Price",
							description:
								"Derived from [price]: Median price calculated for each combination of color and clarity. Null price values are excluded from the calculation.",
							semantic_type: "Money",
							role: "primary",
						},
					],
				...
				s = {
					...
					encoding: {
						...
						tooltip: [
							...
							{ field: "clarity", title: "Clarity", type: "nominal" },
							{
								field: "median_price",
								title: "Median Price",
								type: "quantitative",
						...
						y: { field: "color", sort: "-x", title: "Color", type: "ordinal" },
					},
					$schema: "https://vega.github.io/schema/vega-lite/v6.1.0.json",
				};
			e(
	...
	{ root: document.getElementById("cell-18"), expanded: [], variables: [] },
	{
		...
		body: async (e, t, n, i, o, r, a, l) => {
			const c = {
					...
					summary:
						"A view ranking the average carat weight of diamonds, grouped by their cut and color grades, to identify typical sizes for different quality combinations.",
					fields: [
						{
							name: "cut",
							label: "Cut",
						...
						},
						{
							...
							label: "Average Carat",
							description:
								"Derived from carat: Average aggregated by cut and color.",
							semantic_type: "Numeric",
							role: "primary",
						},
					],
				...
				s = {
					...
					encoding: {
						...
						x: { field: "cut", sort: "-y", title: "Cut", type: "ordinal" },
						y: { field: "color", sort: "-x", title: "Color", type: "ordinal" },
					},
					$schema: "https://vega.github.io/schema/vega-lite/v6.1.0.json",
				};
	...
	{ root: document.getElementById("cell-22"), expanded: [], variables: [] },
	{
		...
		body: async (e, t, n, i, o, r, a, l) => {
			const c = {
					...
					summary:
						"Aggregated diamond properties to explore relationships between clarity, carat weight, and diamond dimensions.",
					fields: [
						{
							name: "clarity",
							label: "Clarity",
						...
						},
						{
							...
							label: "Avg Carat",
							description:
								"Derived from carat: Average of carat grouped by clarity.",
							semantic_type: "Numeric",
							role: "primary",
						},
						{
							...
							label: "Avg Volume",
							description:
								"Derived from x, y, and z: Average of the product of x, y, and z (representing volume) grouped by clarity.",
							semantic_type: "Numeric",
							role: "primary",
						},
					],
...
x(
	{ root: document.getElementById("cell-25"), expanded: [], variables: [] },
	{
		...
		body: async (e, t, n, i) => {
			...
			function y(m, C, A) {
				const f = `SELECT UNNEST("${C}", max_depth := 2) FROM '${A}'`;
				return m.query(`CREATE TABLE IF NOT EXISTS "${C}" AS ${f}`);
			}
			d.formats("arrow", g);
			function E(m, C = "#677389", A = "gray", f = 0.125, Z = "__selected__") {
				const h = JSON.parse(JSON.stringify(m));
				let _,
					te = !1;
				if (h.spec && typeof h.spec == "object") (_ = h.spec), (te = !0);
				else if (
					h.encoding ||
					h.mark ||
					h.layer ||
				...
				return (
					_.encoding?.color
						? j("color", null, A)
						: (_.encoding.color = {
								condition: { test: `datum.${Z}`, value: C },
								value: A,
							}),
					_.encoding?.opacity
						? j("opacity", null, f)
			...
			function lt(m, C) {
				const A = (f) => C.find((Z) => Z.label === f);
				for (const f of m) {
					const Z =
							f.getAttribute("data-field")?.trim() || f.textContent.trim(),
						h = A(Z);
					if (h) {
						const _ = h.description;
						me(f, _);
					} else
			...
			class Ve extends r.MosaicClient {
				...
				#e;
				constructor(C) {
					super(C.filterBy), (this.#n = C.table), (this.#t = E(C.spec));
				}
				async initView() {
					const C = {
							...this.#t,
					...
					for (const Z of f) A.addSignalListener(Z, (h, _) => this.#o(h, _));
				}
				#o(C, A) {}
				query(C = []) {
					return r.Query.from(this.#n).select("*", {
						__selected__: C.length ? r.and(C) : !0,
					});
				}
				queryResult(C) {
			...
			async function Be(m, C) {
				const { coordinator: A, table: f, filterBy: Z } = C,
					h = new Ve({ spec: m, table: f, filterBy: Z });
      ...
      `
				...
				const j = await o(C, {
					...
					P = await Be(f, { coordinator: Z, table: C, filterBy: j.filterBy });
				return { tableClient: j, viewClient: P };
			}
			function Xe(m) {
				const { code: C, baseUrl: A = "https://marimo.app" } = m,
					f = new URL(A);
				if (C) {
					const Z = l.compressToEncodedURIComponent(C);
					f.hash = `#code/${Z}`;
				}
				return f.href;
			}
			function Re(m, C) {
				let A = m;
				for (const [f, Z] of Object.entries(C))
			...
			function dt() {
				...
				const C = document.querySelector(".js-toc");
				if (C) {
...
x(
	{ root: document.getElementById("cell-26"), expanded: [], variables: [] },
	{
		...
		body: () => {
			const e =
					"",
				t = atob(e);
			return {
